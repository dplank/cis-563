...
protected:
	...
	vec4 getRenderColor2(int i, int j, int k); // ADDED!
	vec4 getRenderColor2(const vec3& pt); // ADDED!
	...
	double getDensity2(const vec3& pt); // ADDED!
	...
	void applyPreconditioner(const GridData & r, GridData & z);
	...
	GridData mD2; // ADDED! Second smoke
